          ...
          <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img className="d-block w-100" src="carousel-image-1.jpg" alt="First slide" />
              </div>
              <div className="carousel-item">
                <img className="d-block w-100" src="carousel-image-2.jpg" alt="Second slide" />
              </div>
              <div className="carousel-item">
                <img className="d-block w-100" src="carousel-image-3.jpg" alt="Third slide" />
              </div>
              <div className="carousel-item">
                <img className="d-block w-100" src="carousel-image-4.jpg" alt="Fourth slide" />
              </div>
            </div>
